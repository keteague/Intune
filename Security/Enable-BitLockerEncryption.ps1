...
.NOTES
    ...
    1.0.3 - (2024-03-21) Changed $SystemTemp to $SystemScripts and pointed it to $env:SystemRoot\Scripts to avoid scheduled task failure if $env:SystemRoot\Temp is purged
#>
